...
import VerticalMacOSDock from "./vertical-mac-os-dock";
...
export default function PortfolioHero({ isDockOpen = false, toggleDock }: { isDockOpen?: boolean, toggleDock?: () => void }) {
  ...
  const lastName = nameParts.length > 1 ? nameParts.slice(1).join(" ") : "KANE";
      ...
      <main className="relative min-h-screen flex flex-col">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
              <div className="w-[65px] h-[110px] sm:w-[90px] sm:h-[152px] md:w-[110px] md:h-[185px] lg:w-[129px] lg:h-[218px] rounded-full overflow-hidden shadow-2xl transition-transform duration-300 hover:scale-110 cursor-pointer">
                <img
                  ...
                  style={{ objectFit: 'cover', transform: 'scale(2) translate(-5%, -10%)', transformOrigin: 'center 20%' }}
                />
              </div>
            </div>
          </div>
        ...
        <div className="absolute bottom-16 sm:bottom-20 md:bottom-24 lg:bottom-32 xl:bottom-36 left-1/2 -translate-x-1/2 w-full px-6">
          <div className="flex justify-center">
            <BlurText
              text="Building modern, high-performance web applications."
              delay={150}
              animateBy="words"
              direction="top"
            ...
            apps={[
              {
                ...
                url: 'https://www.linkedin.com/in/supreet-sinha-1295891a7/'
              },
              {
                id: 'github',
                name: 'GitHub',
                icon: 'https://cdn.jim-nielsen.com/macos/1024/github-desktop-2021-05-20.png?rf=1024',
                url: 'https://github.com/supreetsinha4321-glitch'
              },
              {
                id: 'resume',
                name: 'Resume',
